...
in_seq8 = in_seq8.values.reshape((len(in_seq8), 1))
...
# x_input = array([[70,75,5], [80,85,5], [90,95,5]]) x_input = array([[22.879, 23.133000000000003,
# -0.25400000000000134], [22.46, 22.834, -0.3739999999999988], [21.974, 22.331999999999997, -0.357999999999997]])
...
t_seq6 = df_td["Neu"]
t_seq7 = df_td["Pos"]
t_seq8 = df_td["Unemployment"]
t_out = array([t_seq2[i] - t_seq1[i] for i in range(len(t_seq1))])

x_input = []
for i in range(len(t_seq1)):
    tempArray = [t_seq1[i], t_seq2[i], t_seq3[i], t_seq4[i], t_seq5[i], t_seq6[i], t_seq7[i], t_seq8[i], t_out[i]]
